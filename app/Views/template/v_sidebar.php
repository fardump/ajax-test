        ...
        <div class="sidebar-nav">
            ...
            <a href='<?= getURL('product') ?>' class='no-parent'>
                <div class='sidebar-item'>
                    ...
                    <span class='fw-normal fs-7'>City</span>
                </div>
            </a>
            <a href='<?= getURL('category') ?>' class='no-parent'>
                <div class='sidebar-item'>
                    <i class='bx bxs-category'></i>
                    <span class='fw-normal fs-7'>Ekspedition</span>
                </div>
            </a>
            <a href='<?= getURL('project') ?>' class='no-parent'>
                <div class='sidebar-item'>
                    <i class='bx bx-git-branch'></i>
                    <span class='fw-normal fs-7'>Type</span>
                </div>
            </a>
            ...
            <a href='<?= getURL('supplier') ?>' class='no-parent'>
                <div class='sidebar-item'>
                    ...
                    <span class='fw-normal fs-7'>Province</span>
                </div>
            </a>
        </div>
